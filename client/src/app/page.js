...
export default function Home() {
  return (
    <main className="h-fit bg-primary font-sans">
      ...
      <div className="flex flex-col max-[500px]:m-1 m-10 p-10 mt-20">
        <div className="font-bold text-4xl mb-5">What Exactly is Shine Ai?</div>
        <div className="text-wrap text-lg leading-10 text-justify">
        ...
        <div className="font-bold text-4xl mt-20 mb-5">Why Use Shine Ai?</div>
        <div className="text-wrap text-lg leading-10 text-justify">
        ...
        <div className="font-bold text-4xl mt-20 mb-5">The Inspiration</div>
        <div className="text-wrap text-lg leading-10 text-justify">
