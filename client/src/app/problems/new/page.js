...
export default function App() {
  ...
  return (
    <div className="w-full pb-50 font-sans relative transition-colors duration-300 bg-primary">
      ...
      {toast && (
        <div
          className={`fixed top-20 right-10 max-[500px]:right-1 z-50 max-w-md w-full bg-secondary shadow-2xl rounded-xl p-4 flex items-start gap-3 transition-all duration-300 ${toast.type === "error"
            ? "border-red-500/40"
            : "border-green-500/30"
            }`}
        >
      ...
      >
        ...
        <div className="bg-secondary rounded-xl p-20 max-[1000px]:p-10 max-[500px]:px-5 max-[700px]:w-[90vw] space-y-6 w-4/5 shadow-[0_8px_24px_rgba(0,0,0,0.5)]">
